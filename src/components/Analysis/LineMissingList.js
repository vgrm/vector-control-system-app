...
const LineMissingList = ({ classes, ...props }) => {

    const [page, setPage] = useState(0);
    const [rowsPerPage, setRowsPerPage] = useState(5);

    const emptyRows = rowsPerPage - Math.min(rowsPerPage, props.linesMissingList.length - page * rowsPerPage);
        ...
        <Container>
            ...
            <TableContainer component={Paper}>
                <Table size="small" aria-label="a dense table">
                    ...
                    <TableBody>
                        {
                            (rowsPerPage > 0 ? props.linesMissingList.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : props.linesMissingList)
                                .map((line, index) => {
                    ...
                    <TableFooter>
                        <TableRow>
                            <TablePagination
                                ...
                                colSpan={4}
                                count={props.linesMissingList.length}
...
const mapStateToProps = state => ({
    linesMissingList: state.line.listMissing
})

const mapActionToProps = {
    fetchLinesMissing: actions.fetchLinesMissing
}

export default connect(mapStateToProps, mapActionToProps)(withStyles(styles)(LineMissingList));
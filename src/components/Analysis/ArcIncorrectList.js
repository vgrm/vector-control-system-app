...
const ArcIncorrectList = ({ classes, ...props }) => {

    const [page, setPage] = useState(0);
    const [rowsPerPage, setRowsPerPage] = useState(5);

    const emptyRows = rowsPerPage - Math.min(rowsPerPage, props.arcsIncorrectList.length - page * rowsPerPage);
        ...
        <Container>
            ...
            <TableContainer component={Paper}>
                <Table size="small" aria-label="a dense table">
                    ...
                    <TableBody>
                        {
                            (rowsPerPage > 0 ? props.arcsIncorrectList.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : props.arcsIncorrectList)
                                .map((arc, index) => {
                    ...
                    <TableFooter>
                        <TableRow>
                            <TablePagination
                                ...
                                colSpan={4}
                                count={props.arcsIncorrectList.length}
...
const mapStateToProps = state => ({
    arcsIncorrectList: state.arc.listIncorrect
})

const mapActionToProps = {
    fetchArcsIncorrect: actions.fetchArcsIncorrect
}

export default connect(mapStateToProps, mapActionToProps)(withStyles(styles)(ArcIncorrectList));